...
`ellipsefit` is an R package for interactive digitization and quantitative analysis of ellipses from images. It was developed primarily for geological applications such as strain analysis, clast shape analysis, porphyroclasts, reduction spots, ooids, fossils, and other approximately elliptical objects, but can be applied to any image containing elliptical features.
...
Perspective correction should always be performed before scale calibration because perspective transformations alter image geometry.
...
If the image was calibrated, dimensions are additionally reported in calibrated units.
