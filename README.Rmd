...
`ellipsefitR` is an R package for interactive digitization and quantitative analysis of ellipses from images. It was developed primarily for geological applications such as strain analysis, clast shape analysis, porphyroclasts, reduction spots, ooids, fossils, and other approximately elliptical objects, but can be applied to any image containing elliptical features.
